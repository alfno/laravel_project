        ...
        <ul class="space-y-2">
          ...
          <li>
            ...
            <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                <li>
                    <x-sidelink-admin href="/students-admin" :active="request()->is('students-admin')">Student</x-sidelink-admin>
                  </li>
                  <li>
                    <x-sidelink-admin href="/grades-admin" :active="request()->is('grades-admin')">Grade</x-sidelink-admin>
                  </li>
                  <li>
                    <x-sidelink-admin href="/departments-admin" :active="request()->is('departments-admin')">Department</x-sidelink-admin>
                  </li>
            </ul>
            <a
              href="#"
